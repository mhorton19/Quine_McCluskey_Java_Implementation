...
//    }
    public void printSopFromBinary() {
        for (int i = 0; i < functions.size(); i++) {
            System.out.print("f" + getChar(i, false) + " = ");
            for (int y = 0; y < functions.get(i).getNecessaryImplicants().size(); y++) {
                String binary = functions.get(i).getNecessaryImplicants().get(y).getBytes();
                boolean entered = false;
                ...
                if (y < functions.get(i).getNecessaryImplicants().size() - 1) {
                    System.out.print(" + ");
                }
            }
            System.out.println();
    ...
    public void printPosFromBinary() {
        for (int i = 0; i < functions.size(); i++) {
            System.out.print("f" + getChar(i, false) + " = ");
            for (int y = 0; y < functions.get(i).getNecessaryImplicants().size(); y++) {
                System.out.print("(");
